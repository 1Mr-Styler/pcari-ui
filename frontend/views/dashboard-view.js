...
<vaadin-vertical-layout style="width: 100%; overflow: auto;">
 ...
 <vaadin-horizontal-layout theme="spacing-s" id="servicesLayout" style="width: 100%; margin-top: var(--lumo-space-xl); overflow: scroll;"></vaadin-horizontal-layout>
 ...
 <vaadin-horizontal-layout style="align-items: center; justify-content: space-between; margin-left: var(--lumo-space-s); width: 100%; margin-right: var(--lumo-space-xs); margin-top: var(--lumo-space-m); padding-right: var(--lumo-space-m);">
  ...
  <a href="https://vaadin.com" style="text-decoration: none; color: var(--lumo-primary-color);">See All</a>
 </vaadin-horizontal-layout>
 ...
 <label style="margin-top: var(--lumo-space-xl); margin-left: var(--lumo-space-s);">Fast Deall</label>
